...
if __name__ == "__main__":
    ...
    run_name = f"{args.exp_name}_seed_{args.seed}_pi_layers_{args.pi_transformer_layers}_v_layers_{args.v_transformer_layers}_pi_dim_{args.pi_transformer_dim}_v_dim_{args.v_transformer_dim}_pi_heads_{args.pi_num_heads}_v_heads_{args.v_num_heads}_dropout_{args.dropout}_cnn_dim_{args.cnn_feature_dim}_schedule_{args.lr_schedule}_entropy_{args.ent_coef}_lr_{args.learning_rate}"
    print(args)
    if args.track:
        import wandb
