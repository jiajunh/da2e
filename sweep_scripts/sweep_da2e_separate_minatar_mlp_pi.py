...
learning_rate = [2.5e-4, 5.0e-4]
learning_rate_vf = [5.0e-4, 5.0e-4]
batch_size = [1024]
update_epochs = [5]
clip_coef = [0.1]
...
vf_coef = [1.0]
v_transformer_layers = [1, 2]
v_transformer_dim = [64, 128, 256]
v_num_heads = [2, 4]
pi_dim = [128, 256, 512]
cnn_feature_dim = [128]
warmup_frac = [0.10]
...
CMD_TEMPLATE = (
    ...
    "--wandb_project_name sweep_da2e_mlp_pi_separate_{proj_name} "
