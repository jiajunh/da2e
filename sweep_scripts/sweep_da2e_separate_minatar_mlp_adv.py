...
def flush(count: int):
    ...
    script = os.path.join(out_dir, f"sweep_da2e_separate_mlp_pi{batch_idx}.slurm")
    with open(script, "w") as f:
        f.write("#!/bin/bash\n")
        f.write("#SBATCH --job-name=sweep_da2e_separate_mlp_pi_minatari\n")
